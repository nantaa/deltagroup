    ...
    <>
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl text-sm text-gray-700 leading-relaxed space-y-3">
          <p>
            DELTA NUSANTARA PERSADA bermula dari Perusahaan Jasa Pengembangan SDM bidang Perhotelan dan Keselamatan
            Kesehatan Kerja (K3), Softskill serta bidang lain dengan menyesuaikan kebutuhan para pelanggan.
          </p>
          <p>
            DELTA NUSANTARA PERSADA berdiri dari Tahun 1999 berbadan hukum Yayasan dan untuk meningkatkan profesionalitas usaha
      ...
      <section className="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-sm text-gray-600 mb-8 max-w-2xl">
          Dalam merespon kebutuhan sertifikasi kompetensi personal, DELTA NUSANTARA PERSADA bekerjasama dengan Lembaga
