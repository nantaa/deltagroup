...
const MOCK_POSTS: Post[] = [
  ...
  { id: 3, title: 'Jadwal Pelatihan K3 KEMNAKER RI 2025', slug: 'jadwal-k3-2025', excerpt: 'Berikut jadwal pelaksanaan pelatihan K3 dan sertifikasi KEMNAKER RI yang diselenggarakan Delta Nusantara Persada.', content: '', status: 'published', tags: ['Training', 'Jadwal'], category: 'Training', created_at: '2025-11-03', updated_at: '' },
]

const MOCK_BRANDS: Brand[] = [
  { id: 1, name: 'Biro Sertifikasi Indonesia' },
  { id: 2, name: 'Delta Indonesia Pranenggar' },
  { id: 3, name: 'Delta Nusantara Persada' },
