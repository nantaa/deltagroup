...
const MOCK_POSTS: Post[] = [
  ...
  { id: 3, title: 'Riksa Uji K3', slug: 'jadwal-riksa-uji-k3', excerpt: 'Jadwalkan segera Riksa Uji Alat di Delta Nusantara Persada.', content: '', status: 'published', tags: ['Training', 'Jadwal'], category: 'Training', created_at: '2026-11-03', updated_at: '' },
]

const MOCK_BRANDS: Brand[] = [
  { id: 1, name: 'Biro Sertifikasi Indonesia', slug: 'bsi' },
  { id: 2, name: 'Delta Indonesia Pranenggar', slug: 'pranenggar' },
  { id: 3, name: 'Delta Nusantara Persada', slug: 'nusa-persada' },
