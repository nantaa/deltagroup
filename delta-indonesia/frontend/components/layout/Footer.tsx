...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#1a3a6b] text-white pt-14 pb-6">
          ...
          <div className="col-span-1">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                aria-label="Facebook Delta Indonesia"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Instagram Delta Indonesia"
                className="w-8 h-8 border border-white/30 rounded-full flex items-center justify-center text-xs text-white hover:bg-white/15 hover:border-white/60 transition-colors"
              >IG</a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="WhatsApp Delta Indonesia"
                className="w-8 h-8 border border-white/30 rounded-full flex items-center justify-center text-xs text-white hover:bg-white/15 hover:border-white/60 transition-colors"
              >WA</a>
            </div>
          </div>
