...
const STATIC_BRANDS = [
  ...
  { id: 'b3', name: 'Delta Nusantara Persada', slug: 'nusa-persada' },
...
const CLIENTS = [
  ...
  { id: 7, name: 'PT HD Forklift', logo: '/images/logo-client/client-7.png' },
  { id: 8, name: 'PT K-Line Mobaru Indonesia', logo: '/images/logo-client/client-8.png' },
  // Slide 2
  { id: 9, name: 'Mandiri Trans Utama', logo: '/images/logo-client/client-9.png' },
  { id: 10, name: 'PT Bertha Karya Teknik', logo: '/images/logo-client/client-10.png' },
  { id: 11, name: 'PT Ekanuri', logo: '/images/logo-client/client-11.png' },
  ...
  { id: 16, name: 'PT Surgika Alkesindo', logo: '/images/logo-client/client-16.png' },
  // Slide 3
  { id: 17, name: 'PT Asahi Forge Indonesia', logo: '/images/logo-client/client-17.png' },
  { id: 18, name: 'PT Toyota Tsusho Mechanical & Engineering Service Indonesia', logo: '/images/logo-client/client-18.png' },
  { id: 19, name: 'PT Antam Tbk', logo: '/images/logo-client/client-19.png' },
  { id: 20, name: 'PT Air Drilling', logo: '/images/logo-client/client-20.png' },
  { id: 21, name: 'PT Gapura Angkasa', logo: '/images/logo-client/client-21.png' },
  { id: 22, name: 'PT Loka Mampang Indah Realty', logo: '/images/logo-client/client-22.png' },
  { id: 23, name: 'PRSIA Grand Family', logo: '/images/logo-client/client-23.png' },
...
function ClientCard({ client }: { client: typeof CLIENTS[0] }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-2 p-3 rounded-xl border border-gray-100 bg-white hover:shadow-md hover:border-accent/40 transition-all group cursor-default">
          ...
          <div className="flex-1 bg-white border border-gray-200 rounded-[50px] shadow-sm flex items-center overflow-hidden max-w-5xl">
            {visibleBrands.map((brand, idx) => (
              <Link
                ...
                href="/brand"
                className={`group relative flex-1 flex flex-row items-center justify-center gap-2 px-2 py-4 sm:py-6 hover:bg-blue-50/50 hover:scale-105 hover:shadow-lg hover:z-10 rounded-2xl transition-all duration-300 transform ${idx < 2 ? 'border-r border-gray-200 hover:border-transparent' : ''
                  }`}
              >
                <div className="w-14 h-14 sm:w-16 sm:h-16 relative shrink-0 transition-transform duration-300 group-hover:scale-110">
                ...
                <span className="text-[10px] sm:text-xs font-bold text-primary-700 leading-tight max-w-[120px] text-left transition-colors duration-300 group-hover:text-blue-900">
                  {brand?.name ?? 'Brand'}
                </span>
              </Link>
            ))}
