...
export const translations = {
  ...
  home: {
    ...
    clientSection: { ID: 'PERUSAHAAN YANG SUDAH BEKERJA SAMA DENGAN PT. DELTA INDONESIA GROUP', EN: 'COMPANIES THAT HAVE PARTNERED WITH PT. DELTA INDONESIA GROUP' },
  ...
  footer: {
    ...
    copyright: { ID: '© 2025 PT. Delta Indonesia Group. Hak cipta dilindungi.', EN: '© 2025 PT. Delta Indonesia Group. All rights reserved.' },
    serviceItems: {
  ...
  about: {
    ...
    subtitle: { ID: 'PT. Delta Indonesia Group', EN: 'PT. Delta Indonesia Group' },
  },
  berita: {
