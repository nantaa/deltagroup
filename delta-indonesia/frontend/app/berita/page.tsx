...
const MOCK_POSTS: Post[] = [
  { id: 1, title: 'Pentingnya Keselamatan Kerja di Industri', slug: 'keselamatan-kerja', excerpt: 'Keselamatan kerja adalah prioritas utama dalam setiap operasional industri modern.', content: '', status: 'published', tags: ['K3', 'Keselamatan', 'Training'], category: 'K3', created_at: '2025-10-12', updated_at: '' },
  { id: 2, title: 'Sertifikasi Kompetensi Profesional 2025', slug: 'sertifikasi-kompetensi', excerpt: 'Program sertifikasi kompetensi untuk meningkatkan profesionalitas tenaga kerja Indonesia.', content: '', status: 'published', tags: ['Sertifikasi', 'Event', 'Kompetensi'], category: 'Event', created_at: '2025-11-01', updated_at: '' },
  { id: 3, title: 'Jadwal Pelatihan K3 KEMNAKER RI 2025', slug: 'jadwal-k3-2025', excerpt: 'Berikut jadwal pelaksanaan pelatihan K3 dan sertifikasi dari KEMNAKER yang diselenggarakan setiap bulannya.', content: '', status: 'published', tags: ['Training', 'Jadwal', 'K3'], category: 'Training', created_at: '2025-11-03', updated_at: '' },
]
                ...
                {CATEGORIES.map((c) => (
                  <button
                    ...
                    className={`block w-full text-left px-4 py-2.5 text-sm hover:bg-blue-50 hover:text-accent transition-colors first:rounded-t-lg last:rounded-b-lg ${
                      category === c ? 'text-accent font-semibold' : 'text-gray-600'
                    }`}
                  >
                    {c}
                  </button>
