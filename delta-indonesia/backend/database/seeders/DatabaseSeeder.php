    ...
    public function run(): void
    {
        ...
        $posts = [
            [
                ...
                'content' => '<p>Keselamatan kerja merupakan aspek fundamental yang harus diperhatikan oleh setiap perusahaan. Delta Indonesia Group berkomitmen untuk memberikan pelatihan K3 terbaik.</p>',
                'status' => 'published',
                'category' => 'K3',
            ...
            [
                ...
                'content' => '<p>Delta Indonesia Group bersama Lembaga Sertifikasi Profesi (LSP) menyelenggarakan program sertifikasi kompetensi nasional.</p>',
                'status' => 'published',
                'category' => 'Event',
            ...
            [
                ...
                'content' => '<p>Tingkatkan kompetensi tim Anda melalui workshop pengembangan SDM yang dirancang khusus oleh Delta Indonesia Group.</p>',
                'status' => 'draft',
                'category' => 'Training',
