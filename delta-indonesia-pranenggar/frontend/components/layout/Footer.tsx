      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="inline-flex items-center gap-3 bg-white rounded-2xl px-4 py-3 shadow-lg self-start">
              <div className="w-12 h-12 relative shrink-0">
                <Image
                  ...
                  alt="Delta Indonesia Pranenggar"
                  width={48}
                  height={48}
              ...
              <div className="border-l border-gray-200 pl-3">
                ...
                <p className="text-primary-700 font-bold text-sm leading-tight">PRANENGGAR</p>
              </div>
            </div>
            ...
            <iframe
              ...
              title="Delta Indonesia Pranenggar Location"
            />
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-xs text-primary-200">
            {isID
              ? '© 2026 PT. Delta Indonesia Pranenggar. Hak cipta dilindungi undang-undang.'
              : '© 2026 PT. Delta Indonesia Pranenggar. All rights reserved.'}
          </p>
