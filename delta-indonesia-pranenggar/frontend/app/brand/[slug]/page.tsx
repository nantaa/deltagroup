...
const BRAND_DATA: Record<string, { name: string; description: string; longDesc: string; website?: string }> = {
  ...
  'nusa-persada': {
    ...
    longDesc: 'Delta Indonesia Pranenggar menyediakan layanan inspeksi teknis dan quality assurance untuk sektor industri, energi, dan manufaktur. Didukung oleh tenaga ahli bersertifikat internasional.',
  },
  bsi: {
