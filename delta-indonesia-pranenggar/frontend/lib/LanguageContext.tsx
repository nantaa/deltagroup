...
export const translations = {
  nav: {
    ...
    brandChildren: {
      ...
      nusa: { ID: 'Delta Indonesia Pranenggar', EN: 'Delta Indonesia Pranenggar' },
  ...
  home: {
    ...
    clientSection: { ID: 'PERUSAHAAN YANG SUDAH BEKERJA SAMA DENGAN PT. DELTA INDONESIA PRANENGGAR', EN: 'COMPANIES THAT HAVE PARTNERED WITH PT. DELTA INDONESIA PRANENGGAR' },
  ...
  footer: {
    description: {
      ID: 'Delta Indonesia Pranenggar menyelenggarakan Sertifikasi dan pembinaan pelatihan K3 untuk para karyawan maupun calon karyawan di seluruh Indonesia.',
      EN: 'Delta Indonesia Pranenggar provides K3 certification and training programs for employees and job seekers throughout Indonesia.',
    },
    services: { ID: 'Layanan', EN: 'Services' },
    menu: { ID: 'Menu', EN: 'Menu' },
    contactUs: { ID: 'Hubungi Kami', EN: 'Contact Us' },
    followUs: { ID: 'Ikuti Kami', EN: 'Follow Us' },
    copyright: { ID: '© 2026 PT. Delta Indonesia Pranenggar. Hak cipta dilindungi.', EN: '© 2026 PT. Delta Indonesia Pranenggar. All rights reserved.' },
    serviceItems: {
  ...
  about: {
    ...
    subtitle: { ID: 'PT. Delta Indonesia Pranenggar', EN: 'PT. Delta Indonesia Pranenggar' },
  },
  berita: {
