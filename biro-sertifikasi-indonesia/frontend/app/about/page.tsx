...
const mitra = [
  ...
  { id: 2, name: 'Biro Sertifikasi Indonesia', logo: null },
  { id: 3, name: 'Biro Sertifikasi Indonesia', logo: null },
  { id: 4, name: 'Delta Indonesia Pranenggar', logo: null },
  { id: 5, name: 'Biro Sertifikasi Indonesia', logo: null },
    ...
    <>
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl text-sm text-gray-700 leading-relaxed space-y-3">
          <p>
            PT. Biro Sertifikasi Indonesia (BSI) is a subsidiary of PT. Delta Indonesia Group. The company operates as an independent, competitive, and reliable Audit and Management System Certification services institution at both national and international levels.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-sm text-gray-600 mb-8 max-w-2xl">
          Dalam merespon kebutuhan sertifikasi kompetensi personal, BIRO SERTIFIKASI INDONESIA bekerjasama dengan Lembaga
