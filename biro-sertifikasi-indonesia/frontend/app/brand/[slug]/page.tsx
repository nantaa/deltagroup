...
const BRAND_DATA: Record<string, { name: string; description: string; longDesc: string; website?: string }> = {
  ...
  'nusa-persada': {
    ...
    longDesc: 'Biro Sertifikasi Indonesia menyediakan layanan inspeksi teknis dan quality assurance untuk sektor industri, energi, dan manufaktur. Didukung oleh tenaga ahli bersertifikat internasional.',
  },
  bsi: {
    name: 'Biro Sertifikasi Indonesia',
