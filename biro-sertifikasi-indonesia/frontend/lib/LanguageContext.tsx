...
export const translations = {
  nav: {
    ...
    brandChildren: {
      ...
      nusa: { ID: 'Biro Sertifikasi Indonesia', EN: 'Biro Sertifikasi Indonesia' },
  ...
  home: {
    ...
    clientSection: { ID: 'PERUSAHAAN YANG SUDAH BEKERJA SAMA DENGAN PT. BIRO SERTIFIKASI INDONESIA', EN: 'COMPANIES THAT HAVE PARTNERED WITH PT. BIRO SERTIFIKASI INDONESIA' },
  ...
  footer: {
    description: {
      ID: 'Biro Sertifikasi Indonesia menyelenggarakan Sertifikasi dan pembinaan pelatihan K3 untuk para karyawan maupun calon karyawan di seluruh Indonesia.',
      EN: 'Biro Sertifikasi Indonesia provides K3 certification and training programs for employees and job seekers throughout Indonesia.',
    },
    services: { ID: 'Layanan', EN: 'Services' },
    menu: { ID: 'Menu', EN: 'Menu' },
    contactUs: { ID: 'Hubungi Kami', EN: 'Contact Us' },
    followUs: { ID: 'Ikuti Kami', EN: 'Follow Us' },
    copyright: { ID: '© 2026 PT. Biro Sertifikasi Indonesia. Hak cipta dilindungi.', EN: '© 2026 PT. Biro Sertifikasi Indonesia. All rights reserved.' },
    serviceItems: {
  ...
  about: {
    ...
    subtitle: { ID: 'PT. Biro Sertifikasi Indonesia', EN: 'PT. Biro Sertifikasi Indonesia' },
  },
  berita: {
