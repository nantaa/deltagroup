...
const BRAND_DATA: Record<string, { name: string; description: string; longDesc: string; website?: string }> = {
  ...
  'nusa-persada': {
    name: 'Delta Lembaga Kursus',
    description: 'Technical Inspection · Quality Assurance',
    longDesc: 'Delta Lembaga Kursus menyediakan layanan inspeksi teknis dan quality assurance untuk sektor industri, energi, dan manufaktur. Didukung oleh tenaga ahli bersertifikat internasional.',
  },
  bsi: {
