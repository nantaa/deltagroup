...
export default function Footer() {
  ...
  return (
    <footer className="bg-primary-800 text-white pt-14 pb-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="inline-flex items-center gap-3 bg-white rounded-2xl px-4 py-3 shadow-lg self-start">
              ...
              <div className="border-l border-gray-200 pl-3">
                <p className="text-primary-700 font-bold text-sm leading-tight">DELTA LEMBAGA</p>
                <p className="text-primary-700 font-bold text-sm leading-tight">KURSUS</p>
              </div>
            </div>
            ...
            <iframe
              ...
              title="Delta Lembaga Kursus Location"
            />
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-xs text-primary-200">
            {isID
              ? '© 2026 PT. Delta Lembaga Kursus. Hak cipta dilindungi undang-undang.'
              : '© 2026 PT. Delta Lembaga Kursus. All rights reserved.'}
          </p>
