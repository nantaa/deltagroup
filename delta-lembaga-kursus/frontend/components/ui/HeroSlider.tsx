...
const slides = [
  {
    id: 1,
    title: { ID: 'PT. DELTA LEMBAGA KURSUS', EN: 'PT. DELTA LEMBAGA KURSUS' },
    subtitle: {
      ID: 'Pengembangan Sumber Daya Manusia & Pelatihan K3',
      EN: 'Human Resource Development & OSH Training'
    },
    bg: '/images/dip-hero.png',
    stats: [
      { value: '100+', label: { ID: 'Pelanggan Setia', EN: 'Loyal Customers' } },
      { value: '15+', label: { ID: 'Tahun Pengalaman', EN: 'Years of Experience' } },
    ],
  },
  {
    id: 2,
